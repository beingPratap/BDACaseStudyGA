...
Pages with top 5 page view counts are:
<br>
```{r, echo=FALSE, message=FALSE, prompt=FALSE, results='asis'}
orderGaData <- gadata[order(gadata$pageviews, decreasing = TRUE),] 
orderGaData[1,4]
orderGaData[2,4]
orderGaData[3,4]
orderGaData[4,4]
...
**Answer 2**
Pages with the worst exit rates are:
<br>
```{r, echo=FALSE, message=FALSE, prompt=FALSE, results='asis'}
orderGaData <- gadata[order(gadata$exits, decreasing = TRUE),] 
orderGaData[1,4]
orderGaData[2,4]
orderGaData[3,4]
orderGaData[4,4]
...
```
<br>
We will need to look at the content of the page to analyze whether users are getting stuck at some point or if the page needs better UX, Design or just few clear Call to Actions
<br>

3. What are the pages with the highest average time on page? Would you recommend the author to write more on these topics?

**Answer 3**
Pages with the highest average time are:
<br>
```{r, echo=FALSE, message=FALSE, prompt=FALSE, results='asis'}
orderGaData <- gadata[order(gadata$timeonpage, decreasing = TRUE),] 
orderGaData[1,4]
orderGaData[2,4]
orderGaData[3,4]
orderGaData[4,4]
...
```
<br>
Yes, I will recommend the author too look into this content topic
<br>
